...
TEST_DATASET = modelnet_h5_dataset.ModelNetH5Dataset(os.path.join(BASE_DIR, 'data/modelnet40_ply_hdf5_2048/vehicle_test_files_testcar.txt'), batch_size=BATCH_SIZE, npoints=1024,shuffle=False)
        ...
        with tf.Graph().as_default():
            ...
            while TEST_DATASET.has_next_batch():
                ...
                for i in range(-1,-5,-1):
                    fout.write('%d %f ' % (sort_id[0,i],object_score[0,sort_id[0,i]]))
                fout.write('%d %f\n' % (sort_id[0,-5],object_score[0,sort_id[0,-5]]))
                batch_idx += 1
