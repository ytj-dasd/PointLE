...
parser.add_argument('--batch_size', type=int, default=32, help='Batch Size during training [default: 64]')
...
def train(gmm):
    ...
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            if epoch % 15 == 0:
                global model_num
                save_path = saver.save(sess, os.path.join(LOG_DIR, str(model_num) + "model.ckpt"))
