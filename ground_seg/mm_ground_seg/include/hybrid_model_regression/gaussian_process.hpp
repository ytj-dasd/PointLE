#ifndef MM_GAUSSIANPROCESS_HPP
#define MM_GAUSSIANPROCESS_HPP
...
public:
	...
	//input function
	void SetHyperParams(const double f_dLScale = 28.01,
		                const double f_dSigmaF = 1.76, 
		                const double f_dSigmaN = 0.12) {
		m_dLScale = f_dLScale;
		m_dSigmaF = f_dSigmaF;
		m_dSigmaN = f_dSigmaN;
	}; 
